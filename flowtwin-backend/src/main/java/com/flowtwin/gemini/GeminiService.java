...
public class GeminiService {
    ...
    public ChatResponse generateNarration(ScenarioResult result) {
        return generateNarration(promptBuilder.build(result));
    }

    /** Generates narration from a prompt already grounded with AI and recommendation context. */
    public ChatResponse generateNarration(GeminiPromptBuilder.Prompt prompt) {
        if (!isConfigured()) {
